...
object Books {
    ...
    val UKRAINIAN_NUMBER_NAME_MAP = ukrainianBooks
    private val ukrainianBooks: SparseArray<String>
        get() {
            val map = SparseArray<String>(67)
            ...
            map.put(3, "Левит")
            map.put(4, "Числа")
            map.put(5, "Повторення Закону")
            map.put(6, "Iсус Навин")
            map.put(7, "Книга Суддiв")
            map.put(8, "Рут")
            map.put(9, "1-а Самуїлова")
            map.put(10, "2-а Самуїлова")
            map.put(11, "1-а царiв")
            map.put(12, "2-а царiв")
            map.put(13, "1-а хронiки")
            map.put(14, "2-а хронiки")
            map.put(15, "Ездра")
            map.put(16, "Неемія")
            map.put(17, "Естер")
            map.put(18, "Йов")
            map.put(19, "Псалми")
            map.put(20, "Приповiстi")
            map.put(21, "Екклезiяст")
            map.put(22, "Пiсня над пiснями")
            map.put(23, "Iсая")
            map.put(24, "Єремiя")
            map.put(25, "Плач Єремiї")
            map.put(26, "Єзекiїль")
            map.put(27, "Даниїл")
            map.put(28, "Осiя")
            map.put(29, "Йоїл")
            ...
            map.put(38, "Захарiя")
            map.put(39, "Малахiї")
            map.put(40, "Вiд Матвiя")
            map.put(41, "Вiд Марка")
            map.put(42, "Вiд Луки")
            map.put(43, "Вiд Iвана")
            map.put(44, "Дiї")
            map.put(45, "До римлян")
            map.put(46, "1-е до коринтян")
            map.put(47, "2-е до коринтян")
            map.put(48, "До галатiв")
            map.put(49, "До ефесян")
            map.put(50, "До филип'ян")
            map.put(51, "До колоссян")
            map.put(52, "1-е до солунян")
            map.put(53, "2-е до солунян")
            map.put(54, "1-е Тимофiю")
            map.put(55, "2-е Тимофiю")
            map.put(56, "До Тита")
            map.put(57, "До Филимона")
            map.put(58, "До євреїв")
            map.put(59, "Якова")
            map.put(60, "1-е Петра")
            map.put(61, "2-е Петра")
            map.put(62, "1-е Iвана")
            map.put(63, "2-е Iвана")
            map.put(64, "3-е Iвана")
            map.put(65, "Юда")
            map.put(66, "Об'явлення")

            return map
        }

    val SWEDISH_NUMBER_NAME_MAP = swedishBooks
    private val swedishBooks: SparseArray<String>
        get() {
            val map = SparseArray<String>(67)
            ...
            map.put(5, "5 Mosebok")
            map.put(6, "Josua")
            map.put(7, "Domarboken")
            map.put(8, "Rut")
            map.put(9, "1 Samuelsboken")
            map.put(10, "2 Samuelsboken")
            map.put(11, "1 Kungaboken")
            map.put(12, "2 Kungaboken")
            map.put(13, "1 Krönikeboken")
            map.put(14, "2 Krönikeboken")
            map.put(15, "Esra")
            map.put(16, "Nehemja")
            map.put(17, "Ester")
            map.put(18, "Job")
            map.put(19, "Psaltaren")
            map.put(20, "Ordspråksboken")
            map.put(21, "Predikaren")
            map.put(22, "Höga Visan")
            map.put(23, "Jesaja")
            map.put(24, "Jeremia")
            map.put(25, "Klagovisorna")
            map.put(26, "Hesekiel")
            map.put(27, "Daniel")
            map.put(28, "Hosea")
            map.put(29, "Joel")
            ...
            map.put(42, "Lukas")
            map.put(43, "Johannes")
            map.put(44, "Apostlagärningarna")
            map.put(45, "Romarbrevet")
            map.put(46, "1 Korinthierbrevet")
            map.put(47, "2 Korinthierbrevet")
            map.put(48, "Galaterbrevet")
            map.put(49, "Efesierbrevet")
            map.put(50, "Filipperbrevet")
            map.put(51, "Kolosserbrevet")
            map.put(52, "1 Thessalonikerbreve")
            map.put(53, "2 Thessalonikerbreve")
            map.put(54, "1 Timotheosbrevet")
            map.put(55, "2 Timotheosbrevet")
            map.put(56, "Titusbrevet")
            map.put(57, "Filemonbrevet")
            map.put(58, "Hebreerbrevet")
            map.put(59, "Jakobsbrevet")
            map.put(60, "1 Petrusbrevet")
            map.put(61, "2 Petrusbrevet")
            map.put(62, "1 Johannesbrevet")
            map.put(63, "2 Johannesbrevet")
            map.put(64, "3 Johannesbrevet")
            map.put(65, "Judasbrevet")
            map.put(66, "Uppenbarelseboken")
    ...
    val VIETNAMESE_NUMBER_NAME_MAP = vietnameseBooks
    private val vietnameseBooks: SparseArray<String>
        get() {
            val map = SparseArray<String>(67)

            map.put(1, "Sáng-thế Ký")
            map.put(2, "Xuất Ê-díp-tô Ký")
            map.put(3, "Lê-vi Ký")
            map.put(4, "Dân-số Ký")
            map.put(5, "Phục-truyền Luật-lệ Ký")
            map.put(6, "Giô-suê")
            map.put(7, "Các Quan Xét")
            map.put(8, "Ru-tơ")
            map.put(9, "I Sa-mu-ên")
            map.put(10, "II Sa-mu-ên")
            map.put(11, "I Các Vua")
            map.put(12, "II Các Vua")
            map.put(13, "I Sử-ký")
            map.put(14, "II Sử-ký")
            map.put(15, "E-xơ-ra")
            map.put(16, "Nê-hê-mi")
            map.put(17, "Ê-xơ-tê")
            map.put(18, "Gióp")
            map.put(19, "Thi-thiên")
            map.put(20, "Châm-ngôn")
            map.put(21, "Truyền-đạo")
            map.put(22, "Nhã-ca")
            map.put(23, "Ê-sai")
            map.put(24, "Giê-rê-mi")
            map.put(25, "Ca thương")
            map.put(26, "Ê-xê-chi-ên")
            map.put(27, "Đa-ni-ên")
            map.put(28, "Ô-sê")
            map.put(29, "Giô-ên")
            map.put(30, "A-mốt")
            ...
            map.put(33, "Mi-chê")
            map.put(34, "Na-hum")
            map.put(35, "Ha-ba-cúc")
            map.put(36, "Sô-phô-ni")
            map.put(37, "A-ghê")
            map.put(38, "Xa-cha-ri")
            map.put(39, "Ma-la-chi")
            map.put(40, "Ma-thi-ơ")
            map.put(41, "Mác")
            map.put(42, "Lu-ca")
            map.put(43, "Giăng")
            map.put(44, "Công-vụ")
            map.put(45, "Rô-ma")
            map.put(46, "I Cô-rinh-tô")
            map.put(47, "II Cô-rinh-tô")
            map.put(48, "Ga-la-ti")
            map.put(49, "Ê-phê-sô")
            map.put(50, "Phi-líp")
            map.put(51, "Cô-lô-se")
            map.put(52, "I Tê-sa-lô-ni-ca")
            map.put(53, "II Tê-sa-lô-ni-ca")
            map.put(54, "I Ti-mô-thê")
            map.put(55, "II Ti-mô-thê")
            map.put(56, "Tít")
            map.put(57, "Phi-lê-môn")
            map.put(58, "Hê-bơ-rơ")
            map.put(59, "Gia-cơ")
            map.put(60, "I Phi-e-rơ")
            map.put(61, "II Phi-e-rơ")
            map.put(62, "I Giăng")
            map.put(63, "II Giăng")
            map.put(64, "III Giăng")
            map.put(65, "Giu-đe")
            map.put(66, "Khải-huyền")

            return map
        }

    val TAGALOG_NUMBER_NAME_MAP = tagalogBooks
    private val tagalogBooks: SparseArray<String>
        get() {
            val map = SparseArray<String>(67)
            ...
            map.put(2, "EXODO")
            map.put(3, "LEVITICO")
            map.put(4, "MGA BILANG")
            map.put(5, "DEUTERONOMIO")
            map.put(6, "JOSUE")
            map.put(7, "MGA HUKOM")
            map.put(8, "RUTH")
            map.put(9, "I SAMUEL")
            map.put(10, "II SAMUEL")
            map.put(11, "I MGA HARI")
            map.put(12, "II MGA HARI")
            map.put(13, "I MGA CRONICA")
            map.put(14, "II MGA CRONICA")
            map.put(15, "EZRA")
            map.put(16, "NEHEMIAS")
            map.put(17, "ESTHER")
            map.put(18, "JOB")
            map.put(19, "MGA AWIT")
            map.put(20, "MGA KAWIKAAN")
            map.put(21, "ECLESIASTES")
            map.put(22, "ANG AWIT NG MGA AWIT")
            map.put(23, "ISAIAS")
            map.put(24, "JEREMIAS")
            map.put(25, "MGA PANAGHOY")
            map.put(26, "EZEKIEL")
            map.put(27, "DANIEL")
            map.put(28, "OSEAS")
            map.put(29, "JOEL")
            ...
            map.put(42, "LUCAS")
            map.put(43, "JUAN")
            map.put(44, "ANG MGA GAWA")
            map.put(45, "MGA TAGA ROMA")
            map.put(46, "I MGA TAGA CORINTO")
            map.put(47, "II MGA TAGA CORINTO")
            map.put(48, "GALACIA")
            map.put(49, "EFESO")
            map.put(50, "FILIPOS")
            map.put(51, "COLOSAS")
            map.put(52, "I MGA TAGA TESALONICA")
            map.put(53, "II MGA TAGA TESALONICA")
            map.put(54, "I TIMOTEO")
            map.put(55, "II TIMOTEO")
            map.put(56, "TITO")
            map.put(57, "FILEMON")
            map.put(58, "MGA HEBREO")
            map.put(59, "SANTIAGO")
            map.put(60, "I PEDRO")
            map.put(61, "II PEDRO")
            map.put(62, "I JUAN")
    ...
    val NEPALI_NUMBER_NAME_MAP = nepaliBooks
    private val nepaliBooks: SparseArray<String>
        get() {
            val map = SparseArray<String>(67)
            ...
            map.put(3, "लेवी")
            map.put(4, "गन्‍ती")
            map.put(5, "व्‍यवस्‍था")
            map.put(6, "यहोशू")
            map.put(7, "न्यायकर्ता")
            map.put(8, "रूथ")
            map.put(9, "१ शमूएल")
            map.put(10, "२ शमूएल")
            map.put(11, "१ राजा")
            ...
            map.put(14, "२ इतिहास")
            map.put(15, "एज्रा")
            map.put(16, "नहेम्‍याह")
            map.put(17, "एस्‍तर")
            map.put(18, "अय्‍यूब")
            map.put(19, "भजनसंग्रह")
            map.put(20, "हितोपदेश")
            map.put(21, "उपदेशक")
            map.put(22, "श्रेष्‍ठगीत")
            map.put(23, "यशैया")
            map.put(24, "यर्मिया")
            map.put(25, "विलाप")
            map.put(26, "इजकिएल")
            ...
            map.put(44, "प्रेरित")
            map.put(45, "रोमी")
            map.put(46, "१ कोरिन्थी")
            map.put(47, "२ कोरिन्थी")
            map.put(48, "गलाती")
            map.put(49, "एफिसी")
            map.put(50, "फिलिप्पी")
            map.put(51, "कलस्सी")
            map.put(52, "१ थेसलोनिकी")
            map.put(53, "२ थेसलोनिकी")
            map.put(54, "१ तिमोथी")
            map.put(55, "२ तिमोथी")
            map.put(56, "तीतस")
            map.put(57, "फिलेमोन")
            ...
            map.put(60, "१ पत्रुस")
            map.put(61, "२ पत्रुस")
            map.put(62, "१ यूहन्‍ना")
            map.put(63, "२ यूहन्‍ना")
            map.put(64, "३ यूहन्‍ना")
            map.put(65, "यहूदा")
            map.put(66, "प्रकाश")
    ...
    val INDONESIAN_NUMBER_NAME_MAP = indonesianBooks
    private val indonesianBooks: SparseArray<String>
        get() {
            val map = SparseArray<String>(67)
            ...
            map.put(5, "Ulangan")
            map.put(6, "Yosua")
            map.put(7, "Hakim-hakim")
            map.put(8, "Rut")
            map.put(9, "1 Samuel")
            map.put(10, "2 Samuel")
            map.put(11, "1 Raja-raja")
            map.put(12, "2 Raja-raja")
            map.put(13, "1 Tawarikh")
            map.put(14, "2 Tawarikh")
            map.put(15, "Ezra")
            map.put(16, "Nehemia")
            map.put(17, "Ester")
            map.put(18, "Ayub")
            map.put(19, "Mazmur")
            map.put(20, "Amsal")
            map.put(21, "Pengkhotbah")
            map.put(22, "Kidung Agung")
            map.put(23, "Yesaya")
            map.put(24, "Yeremia")
            map.put(25, "Ratapan")
            map.put(26, "Yehezkiel")
            map.put(27, "Daniel")
            map.put(28, "Hosea")
            map.put(29, "Y\"oel")
            map.put(30, "Amos")
            ...
            map.put(42, "Lukas")
            map.put(43, "Yohanes")
            map.put(44, "Kisah Para Rasul")
            map.put(45, "Roma")
            map.put(46, "1 Korintus")
            map.put(47, "2 Korintus")
            map.put(48, "Galatia")
            map.put(49, "Efesus")
            map.put(50, "Filipi")
            map.put(51, "Kolose")
            map.put(52, "1 Tesalonika")
            map.put(53, "2 Tesalonika")
            map.put(54, "1 Timotius")
            map.put(55, "2 Timotius")
            map.put(56, "Titus")
            map.put(57, "Filemon")
            map.put(58, "Ibrani")
            map.put(59, "Yakobus")
            map.put(60, "1 Petrus")
            map.put(61, "2 Petrus")
            map.put(62, "1 Yohanes")
            map.put(63, "2 Yohanes")
            map.put(64, "3 Yohanes")
            map.put(65, "Yudas")
            map.put(66, "Wahyu")
    ...
    val THAI_NUMBER_NAME_MAP = thaiBooks
    private val thaiBooks: SparseArray<String>
        get() {
            val map = SparseArray<String>(67)
            ...
            map.put(2, "อพยพ")
            map.put(3, "เลวีนิติ")
            map.put(4, "กันดารวิถี")
            map.put(5, "เฉลยธรรมบัญญัติ")
            map.put(6, "โยชูวา")
            map.put(7, "ผู้วินิจฉัย")
            map.put(8, "นางรูธ")
            map.put(9, "1 ซามูเอล")
            map.put(10, "2 ซามูเอล")
            map.put(11, "1 พงศ์กษัตริย์")
            map.put(12, "2 พงศ์กษัตริย์")
            map.put(13, "1 พงศาวดาร")
            map.put(14, "2 พงศาวดาร")
            map.put(15, "เอสรา")
            map.put(16, "เนหะมีย์")
            map.put(17, "เอสเธอร์")
            map.put(18, "โยบ")
            map.put(19, "สดุดี")
            map.put(20, "สุภาษิต")
            map.put(21, "ปัญญาจารย์")
            map.put(22, "เพลงซาโลมอน")
            map.put(23, "อิสยาห์")
            map.put(24, "เยเรมีย์")
            map.put(25, "เพลงคร่ำครวญ")
            map.put(26, "เอเสเคียล")
            map.put(27, "ดาเนียล")
            map.put(28, "โฮเชยา")
            map.put(29, "โยเอล")
            map.put(30, "อาโมส")
            ...
            map.put(34, "นาฮูม")
            map.put(35, "ฮาบากุก")
            map.put(36, "เศฟันยาห์")
            map.put(37, "ฮักกัย")
            map.put(38, "เศคาริยาห์")
            map.put(39, "มาลาคี")
            map.put(40, "มัทธิว")
            map.put(41, "มาระโก")
            map.put(42, "ลูกา")
            ...
            map.put(44, "กิจการ")
            map.put(45, "โรม")
            map.put(46, "1 โครินธ์")
            map.put(47, "2 โครินธ์")
            map.put(48, "กาลาเทีย")
            map.put(49, "เอเฟซัส")
            map.put(50, "ฟีลิปปี")
            map.put(51, "โคโลสี")
            map.put(52, "1 เธสะโลนิกา")
            map.put(53, "2 เธสะโลนิกา")
            map.put(54, "1 ทิโมธี")
            map.put(55, "2 ทิโมธี")
            map.put(56, "ทิตัส")
            map.put(57, "ฟีเลโมน")
    ...
    val TRADITIONAL_CHINESE_NUMBER_NAME_MAP = traditionalChineseBooks
    private val traditionalChineseBooks: SparseArray<String>
        get() {
            val map = SparseArray<String>(67)
            map.put(1, "創世記")
            map.put(2, "出埃及記")
